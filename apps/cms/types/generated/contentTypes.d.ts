...
export interface ApiContactInfoContactInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactItems: Schema.Attribute.DynamicZone<['common.link-tile']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::contact-info.contact-info'> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiDesignSkillDesignSkill extends Struct.CollectionTypeSchema {
  collectionName: 'design_skills';
  info: {
    displayName: 'Design Skill';
    pluralName: 'design-skills';
    singularName: 'design-skill';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::design-skill.design-skill'> & Schema.Attribute.Private;
    logo: Schema.Attribute.Media<'images' | 'files'> & Schema.Attribute.Required;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    orderIndex: Schema.Attribute.Integer & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFrontEndSkillFrontEndSkill extends Struct.CollectionTypeSchema {
  collectionName: 'front_end_skills';
  info: {
    displayName: 'Front end skill';
    pluralName: 'front-end-skills';
    singularName: 'front-end-skill';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::front-end-skill.front-end-skill'> &
      Schema.Attribute.Private;
...
export interface ApiIntroductionIntroduction extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::introduction.introduction'> & Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      [
        'content-blocks.single-media-item',
        'content-blocks.rich-text',
        'content-blocks.lottie-animation',
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    goToProjectButton: Schema.Attribute.Component<'common.button', false>;
    image: Schema.Attribute.Media<'images' | 'files'>;
    introText: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::project.project'> & Schema.Attribute.Private;
    name: Schema.Attribute.String;
    nameInUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    tags: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::array-field.array',
        {
          options: 'Front end, Visual design, UX / UI, Motion design';
        }
      >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::design-skill.design-skill': ApiDesignSkillDesignSkill;
      'api::experience.experience': ApiExperienceExperience;
      'api::front-end-skill.front-end-skill': ApiFrontEndSkillFrontEndSkill;
